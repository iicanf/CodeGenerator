...
public class ModelAndMapperGenerator extends CodeGeneratorManager implements CodeGenerator {
    ...
    private Context initConfig(String tableName, String modelName, String sign) {
        ...
        try {
            ...
            String targetPackage = CodeGeneratorConfig.TABLE_SIGN_ENABLE ? MODEL_PACKAGE + "." + sign : MODEL_PACKAGE;
            javaModelGeneratorConfiguration.setTargetPackage(targetPackage);
            context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

            JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
            javaClientGeneratorConfiguration.setTargetProject(PROJECT_PATH + JAVA_PATH);
            targetPackage = CodeGeneratorConfig.TABLE_SIGN_ENABLE ? MAPPER_PACKAGE + "." + sign : MAPPER_PACKAGE;
